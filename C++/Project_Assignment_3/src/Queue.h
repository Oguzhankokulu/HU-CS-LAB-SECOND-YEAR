...
#define MAX_QUEUE_SIZE 80  // I increased the size because adding same neighbors is a possible case// TO DO: Define a maximum size for the queue to control memory usage considering the problem at hand
...
public:
    ...
    // Check if province exist in the queue
    bool isInQueue(int province) const;
};
